...
shared static this() {
	...
	cast()cc1C01Table = [
		...
		CC1C01Entry(CC1C01Type.integer | PartyCharacter.hp.current.value.integer.sizeof, &partyCharacters[0].hp.current.value.integer),
		...
		CC1C01Entry(CC1C01Type.integer | PartyCharacter.pp.current.value.integer.sizeof, &partyCharacters[0].pp.current.value.integer),
		...
		CC1C01Entry(CC1C01Type.integer | PartyCharacter.hp.current.value.integer.sizeof, &partyCharacters[1].hp.current.value.integer),
		...
		CC1C01Entry(CC1C01Type.integer | PartyCharacter.pp.current.value.integer.sizeof, &partyCharacters[1].pp.current.value.integer),
		...
		CC1C01Entry(CC1C01Type.integer | PartyCharacter.hp.current.value.integer.sizeof, &partyCharacters[2].hp.current.value.integer),
		...
		CC1C01Entry(CC1C01Type.integer | PartyCharacter.pp.current.value.integer.sizeof, &partyCharacters[2].pp.current.value.integer),
		...
		CC1C01Entry(CC1C01Type.integer | PartyCharacter.hp.current.value.integer.sizeof, &partyCharacters[3].hp.current.value.integer),
		...
		CC1C01Entry(CC1C01Type.integer | PartyCharacter.pp.current.value.integer.sizeof, &partyCharacters[3].pp.current.value.integer),
