...
immutable PSIAbility[54] PSIAbilityTable = [
	PSIAbility(0x00, 0x00, 0x00, 0x00, BattleActions.NoEffect, 0x00, 0x00, 0x00, 0x00, 0x00, null/+NULL+/),
	PSIAbility(PSIID.Rockin, PSILevel.Alpha, PSICategory.Offense, PSITarget.Enemies, BattleActions.PSI_ROCKIN_ALPHA, 0x08, 0x00, 0x00, 0x09, 0x00, null/+TEXT_PSI_ROCKIN_ALPHA_DESC+/),
	PSIAbility(PSIID.Rockin, PSILevel.Beta, PSICategory.Offense, PSITarget.Enemies, BattleActions.PSI_ROCKIN_BETA, 0x16, 0x00, 0x00, 0x0B, 0x00, null/+TEXT_PSI_ROCKIN_BETA_DESC+/),
	PSIAbility(PSIID.Rockin, PSILevel.Gamma, PSICategory.Offense, PSITarget.Enemies, BattleActions.PSI_ROCKIN_GAMMA, 0x31, 0x00, 0x00, 0x0D, 0x00, null/+TEXT_PSI_ROCKIN_GAMMA_DESC+/),
	PSIAbility(PSIID.Rockin, PSILevel.Omega, PSICategory.Offense, PSITarget.Enemies, BattleActions.PSI_ROCKIN_OMEGA, 0x4B, 0x00, 0x00, 0x0F, 0x00, null/+TEXT_PSI_ROCKIN_OMEGA_DESC+/),
	PSIAbility(PSIID.Fire, PSILevel.Alpha, PSICategory.Offense, PSITarget.Enemies, BattleActions.PSI_FIRE_ALPHA, 0x00, 0x03, 0x00, 0x09, 0x00, null/+TEXT_PSI_FIRE_ALPHA_DESC+/),
	PSIAbility(PSIID.Fire, PSILevel.Beta, PSICategory.Offense, PSITarget.Enemies, BattleActions.PSI_FIRE_BETA, 0x00, 0x13, 0x00, 0x0B, 0x00, null/+TEXT_PSI_FIRE_BETA_DESC+/),
	PSIAbility(PSIID.Fire, PSILevel.Gamma, PSICategory.Offense, PSITarget.Enemies, BattleActions.PSI_FIRE_GAMMA, 0x00, 0x25, 0x00, 0x0D, 0x00, null/+TEXT_PSI_FIRE_GAMMA_DESC+/),
	PSIAbility(PSIID.Fire, PSILevel.Omega, PSICategory.Offense, PSITarget.Enemies, BattleActions.PSI_FIRE_OMEGA, 0x00, 0x40, 0x00, 0x0F, 0x00, null/+TEXT_PSI_FIRE_OMEGA_DESC+/),
	PSIAbility(PSIID.Freeze, PSILevel.Alpha, PSICategory.Offense, PSITarget.Enemies, BattleActions.PSI_FREEZE_ALPHA, 0x00, 0x01, 0x01, 0x09, 0x01, null/+TEXT_PSI_FREEZE_ALPHA_DESC+/),
	PSIAbility(PSIID.Freeze, PSILevel.Beta, PSICategory.Offense, PSITarget.Enemies, BattleActions.PSI_FREEZE_BETA, 0x00, 0x0B, 0x01, 0x0B, 0x01, null/+TEXT_PSI_FREEZE_BETA_DESC+/),
	PSIAbility(PSIID.Freeze, PSILevel.Gamma, PSICategory.Offense, PSITarget.Enemies, BattleActions.PSI_FREEZE_GAMMA, 0x00, 0x1F, 0x21, 0x0D, 0x01, null/+TEXT_PSI_FREEZE_GAMMA_DESC+/),
	PSIAbility(PSIID.Freeze, PSILevel.Omega, PSICategory.Offense, PSITarget.Enemies, BattleActions.PSI_FREEZE_OMEGA, 0x00, 0x2E, 0x00, 0x0F, 0x01, null/+TEXT_PSI_FREEZE_OMEGA_DESC+/),
	PSIAbility(PSIID.Thunder, PSILevel.Alpha, PSICategory.Offense, PSITarget.Enemies, BattleActions.PSI_THUNDER_ALPHA, 0x00, 0x08, 0x01, 0x09, 0x02, null/+TEXT_PSI_THUNDER_ALPHA_DESC+/),
	PSIAbility(PSIID.Thunder, PSILevel.Beta, PSICategory.Offense, PSITarget.Enemies, BattleActions.PSI_THUNDER_BETA, 0x00, 0x19, 0x01, 0x0B, 0x02, null/+TEXT_PSI_THUNDER_BETA_DESC+/),
	PSIAbility(PSIID.Thunder, PSILevel.Gamma, PSICategory.Offense, PSITarget.Enemies, BattleActions.PSI_THUNDER_GAMMA, 0x00, 0x39, 0x29, 0x0D, 0x02, null/+TEXT_PSI_THUNDER_GAMMA_DESC+/),
	PSIAbility(PSIID.Thunder, PSILevel.Omega, PSICategory.Offense, PSITarget.Enemies, BattleActions.PSI_THUNDER_OMEGA, 0x00, 0x00, 0x37, 0x0F, 0x02, null/+TEXT_PSI_THUNDER_OMEGA_DESC+/),
	PSIAbility(PSIID.Flash, PSILevel.Alpha, PSICategory.Offense, PSITarget.Enemies, BattleActions.PSI_FLASH_ALPHA, 0x12, 0x00, 0x00, 0x09, 0x01, null/+TEXT_PSI_FLASH_ALPHA_DESC+/),
	PSIAbility(PSIID.Flash, PSILevel.Beta, PSICategory.Offense, PSITarget.Enemies, BattleActions.PSI_FLASH_BETA, 0x26, 0x00, 0x00, 0x0B, 0x01, null/+TEXT_PSI_FLASH_BETA_DESC+/),
	PSIAbility(PSIID.Flash, PSILevel.Gamma, PSICategory.Offense, PSITarget.Enemies, BattleActions.PSI_FLASH_GAMMA, 0x3D, 0x00, 0x00, 0x0D, 0x01, null/+TEXT_PSI_FLASH_GAMMA_DESC+/),
	PSIAbility(PSIID.Flash, PSILevel.Omega, PSICategory.Offense, PSITarget.Enemies, BattleActions.PSI_FLASH_OMEGA, 0x43, 0x00, 0x00, 0x0F, 0x01, null/+TEXT_PSI_FLASH_OMEGA_DESC+/),
	PSIAbility(PSIID.Starstorm, PSILevel.Alpha, PSICategory.Offense, PSITarget.Enemies, BattleActions.PSI_STARSTORM_ALPHA, 0x00, 0x00, 0x00, 0x09, 0x00, null/+TEXT_PSI_STARSTORM_ALPHA_DESC+/),
	PSIAbility(PSIID.Starstorm, PSILevel.Omega, PSICategory.Offense, PSITarget.Enemies, BattleActions.PSI_STARSTORM_BETA, 0x00, 0x00, 0x00, 0x0B, 0x00, null/+TEXT_PSI_STARSTORM_OMEGA_DESC+/),
	PSIAbility(PSIID.Lifeup, PSILevel.Alpha, PSICategory.Recover, PSITarget.Allies, BattleActions.PSILifeupAlpha, 0x02, 0x00, 0x01, 0x09, 0x00, null/+TEXT_PSI_LIFEUP_ALPHA_DESC+/),
	PSIAbility(PSIID.Lifeup, PSILevel.Beta, PSICategory.Recover, PSITarget.Allies, BattleActions.PSILifeupBeta, 0x14, 0x00, 0x01, 0x0B, 0x00, null/+TEXT_PSI_LIFEUP_BETA_DESC+/),
	PSIAbility(PSIID.Lifeup, PSILevel.Gamma, PSICategory.Recover, PSITarget.Allies, BattleActions.PSILifeupGamma, 0x27, 0x00, 0x2E, 0x0D, 0x00, null/+TEXT_PSI_LIFEUP_GAMMA_DESC+/),
	PSIAbility(PSIID.Lifeup, PSILevel.Omega, PSICategory.Recover, PSITarget.Allies, BattleActions.PSILifeupOmega, 0x46, 0x00, 0x00, 0x0F, 0x00, null/+TEXT_PSI_LIFEUP_OMEGA_DESC+/),
	PSIAbility(PSIID.Healing, PSILevel.Alpha, PSICategory.Recover, PSITarget.Allies, BattleActions.PSIHealingAlpha, 0x0A, 0x00, 0x01, 0x09, 0x01, null/+TEXT_PSI_HEALING_ALPHA_DESC+/),
	PSIAbility(PSIID.Healing, PSILevel.Beta, PSICategory.Recover, PSITarget.Allies, BattleActions.PSIHealingBeta, 0x18, 0x00, 0x01, 0x0B, 0x01, null/+TEXT_PSI_HEALING_BETA_DESC+/),
	PSIAbility(PSIID.Healing, PSILevel.Gamma, PSICategory.Recover, PSITarget.Allies, BattleActions.PSIHealingGamma, 0x35, 0x00, 0x24, 0x0D, 0x01, null/+TEXT_PSI_HEALING_GAMMA_DESC+/),
	PSIAbility(PSIID.Healing, PSILevel.Omega, PSICategory.Recover, PSITarget.Allies, BattleActions.PSIHealingOmega, 0x00, 0x00, 0x34, 0x0F, 0x01, null/+TEXT_PSI_HEALING_OMEGA_DESC+/),
	PSIAbility(PSIID.Shield, PSILevel.Alpha, PSICategory.Assist, PSITarget.Enemies, BattleActions.PSIShieldAlpha, 0x0C, 0x00, 0x0E, 0x09, 0x00, null/+TEXT_SHIELD_ALPHA_DESC+/),
	PSIAbility(PSIID.Shield, PSILevel.Sigma, PSICategory.Assist, PSITarget.Enemies, BattleActions.PSIShieldSigma, 0x00, 0x00, 0x0F, 0x0B, 0x00, null/+TEXT_SHIELD_SIGMA_DESC+/),
	PSIAbility(PSIID.Shield, PSILevel.Beta, PSICategory.Assist, PSITarget.Enemies, BattleActions.PSIShieldBeta, 0x22, 0x00, 0x10, 0x0D, 0x00, null/+TEXT_SHIELD_BETA_DESC+/),
	PSIAbility(PSIID.Shield, PSILevel.Omega, PSICategory.Assist, PSITarget.Enemies, BattleActions.PSIShieldOmega, 0x00, 0x00, 0x33, 0x0F, 0x00, null/+TEXT_SHIELD_OMEGA_DESC+/),
	PSIAbility(PSIID.PSIShield, PSILevel.Alpha, PSICategory.Assist, PSITarget.Enemies, BattleActions.PSIPSIShieldAlpha, 0x00, 0x06, 0x00, 0x09, 0x00, null/+TEXT_PSI_SHIELD_ALPHA_DESC+/),
	PSIAbility(PSIID.PSIShield, PSILevel.Sigma, PSICategory.Assist, PSITarget.Enemies, BattleActions.PSIPSIShieldSigma, 0x00, 0x1B, 0x00, 0x0B, 0x00, null/+TEXT_PSI_SHIELD_SIGMA_DESC+/),
	PSIAbility(PSIID.PSIShield, PSILevel.Beta, PSICategory.Assist, PSITarget.Enemies, BattleActions.PSIPSIShieldBeta, 0x00, 0x33, 0x00, 0x0D, 0x00, null/+TEXT_PSI_SHIELD_BETA_DESC+/),
	PSIAbility(PSIID.PSIShield, PSILevel.Omega, PSICategory.Assist, PSITarget.Enemies, BattleActions.PSIPSIShieldOmega, 0x00, 0x3C, 0x00, 0x0F, 0x00, null/+TEXT_PSI_SHIELD_OMEGA_DESC+/),
	PSIAbility(PSIID.OffenseUp, PSILevel.Alpha, PSICategory.Assist, PSITarget.Enemies, BattleActions.PSI_OFFENSE_UP_ALPHA, 0x00, 0x15, 0x00, 0x09, 0x01, null/+TEXT_PSI_OFFENSE_UP_ALPHA_DESC+/),
	PSIAbility(PSIID.OffenseUp, PSILevel.Omega, PSICategory.Assist, PSITarget.Enemies, BattleActions.PSI_OFFENSE_UP_OMEGA, 0x00, 0x28, 0x00, 0x0B, 0x01, null/+TEXT_PSI_OFFENSE_UP_OMEGA_DESC+/),
	PSIAbility(PSIID.DefenseDown, PSILevel.Alpha, PSICategory.Assist, PSITarget.Enemies, BattleActions.PSI_DEFENSE_DOWN_ALPHA, 0x00, 0x1D, 0x00, 0x09, 0x02, null/+TEXT_PSI_DEFENSE_DOWN_ALPHA_DESC+/),
	PSIAbility(PSIID.DefenseDown, PSILevel.Omega, PSICategory.Assist, PSITarget.Enemies, BattleActions.PSI_DEFENSE_DOWN_OMEGA, 0x00, 0x36, 0x00, 0x0B, 0x02, null/+TEXT_PSI_DEFENSE_DOWN_OMEGA_DESC+/),
	PSIAbility(PSIID.Hypnosis, PSILevel.Alpha, PSICategory.Assist, PSITarget.Enemies, BattleActions.PSI_HYPNOSIS_ALPHA, 0x04, 0x00, 0x00, 0x09, 0x01, null/+TEXT_PSI_HYPNOSIS_ALPHA_DESC+/),
	PSIAbility(PSIID.Hypnosis, PSILevel.Omega, PSICategory.Assist, PSITarget.Enemies, BattleActions.PSI_HYPNOSIS_OMEGA, 0x1B, 0x00, 0x00, 0x0B, 0x01, null/+TEXT_PSI_HYPNOSIS_OMEGA_DESC+/),
	PSIAbility(PSIID.Magnet, PSILevel.Alpha, PSICategory.Recover, PSITarget.Enemies, BattleActions.PSI_MAGNET_ALPHA, 0x00, 0x0F, 0x15, 0x09, 0x02, null/+TEXT_PSI_MAGNET_ALPHA_DESC+/),
	PSIAbility(PSIID.Magnet, PSILevel.Omega, PSICategory.Recover, PSITarget.Enemies, BattleActions.PSI_MAGNET_OMEGA, 0x00, 0x18, 0x1B, 0x0B, 0x02, null/+TEXT_PSI_MAGNET_OMEGA_DESC+/),
	PSIAbility(PSIID.Paralysis, PSILevel.Alpha, PSICategory.Assist, PSITarget.Enemies, BattleActions.PSI_PARALYSIS_ALPHA, 0x0E, 0x00, 0x00, 0x09, 0x02, null/+TEXT_PSI_PARALYSIS_ALPHA_DESC+/),
	PSIAbility(PSIID.Paralysis, PSILevel.Omega, PSICategory.Assist, PSITarget.Enemies, BattleActions.PSI_PARALYSIS_OMEGA, 0x1D, 0x00, 0x00, 0x0B, 0x02, null/+TEXT_PSI_PARALYSIS_OMEGA_DESC+/),
	PSIAbility(PSIID.Brainshock, PSILevel.Alpha, PSICategory.Assist, PSITarget.Enemies, BattleActions.PSI_BRAINSHOCK_ALPHA, 0x00, 0x00, 0x18, 0x09, 0x01, null/+TEXT_PSI_BRAINSHOCK_ALPHA_DESC+/),
	PSIAbility(PSIID.Brainshock, PSILevel.Omega, PSICategory.Assist, PSITarget.Enemies, BattleActions.PSI_BRAINSHOCK_OMEGA, 0x00, 0x00, 0x2C, 0x0B, 0x01, null/+TEXT_PSI_BRAINSHOCK_OMEGA_DESC+/),
	PSIAbility(PSIID.Teleport, PSILevel.Alpha, PSICategory.Other, PSITarget.Nobody, BattleActions.PSI_TELEPORT_ALPHA, 0x00, 0x00, 0x11, 0x09, 0x02, null/+TEXT_PSI_TELEPORT_ALPHA_DESC+/),
	PSIAbility(PSIID.Teleport, PSILevel.Beta, PSICategory.Other, PSITarget.Nobody, BattleActions.PSI_TELEPORT_OMEGA, 0x00, 0x00, 0x12, 0x0B, 0x02, null/+TEXT_PSI_TELEPORT_BETA_DESC+/),
	PSIAbility(0x00, 0x00, 0x00, 0x00, BattleActions.NoEffect, 0x00, 0x00, 0x00, 0x00, 0x00, null/+NULL+/),
];
