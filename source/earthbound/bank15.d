...
immutable PSITeleportDestination[17] psiTeleportDestinationTable = [
	...
	PSITeleportDestination(ebString!25("Onett"), EventFlag.onettReached, 253, 186),
	PSITeleportDestination(ebString!25("Twoson"), EventFlag.twosonReached, 176, 820),
	PSITeleportDestination(ebString!25("Threed"), EventFlag.threedReached, 692, 1126),
	PSITeleportDestination(ebString!25("Saturn Valley"), EventFlag.saturnValleyReached, 34, 972),
	PSITeleportDestination(ebString!25("Fourside"), EventFlag.foursideReached, 380, 505),
	PSITeleportDestination(ebString!25("Winters"), EventFlag.wintersReached, 62, 289),
	PSITeleportDestination(ebString!25("Summers"), EventFlag.summersReached, 554, 353),
	PSITeleportDestination(ebString!25("Scaraba"), EventFlag.scarabaReached, 152, 526),
	PSITeleportDestination(ebString!25("Dalaam"), EventFlag.dalaamReached, 570, 449),
	PSITeleportDestination(ebString!25("Deep Darkness"), EventFlag.deepDarknessReached, 704, 896),
	PSITeleportDestination(ebString!25("Tenda Village"), EventFlag.tendaVillageReached, 564, 889),
	PSITeleportDestination(ebString!25("Underworld"), EventFlag.underworldReached, 325, 351),
	PSITeleportDestination(ebString!25(""), EventFlag.unknown092, 433, 515),
	PSITeleportDestination(ebString!25("Dusty Dunes"), EventFlag.unknown254, 160, 1251),
	PSITeleportDestination(ebString!25(""), EventFlag.unknown092, 750, 747),
	PSITeleportDestination(ebString!25(""), EventFlag.none, 0, 0),
];
...
immutable TelephoneContact[7] telephoneContacts = [
	...
	TelephoneContact(ebString!25("Dad"), EventFlag.dadPhoneUnlocked, textPhoneDad),
	TelephoneContact(ebString!25("Mom"), EventFlag.momPhoneUnlocked, textPhoneMom),
	TelephoneContact(ebString!25("Escargo Express"), EventFlag.escargoExpressPhoneUnlocked, textPhoneEscargoExpress),
	TelephoneContact(ebString!25("Mach Pizza"), EventFlag.machPizzaPhoneUnlocked, textPhoneMachPizza),
	TelephoneContact(ebString!25("Stoic Club"), EventFlag.stoicClubPhoneUnlocked, textPhoneStoicClub),
	TelephoneContact(ebString!25(""), EventFlag.none, null),
];
...
immutable TimedDelivery[10] timedDeliveries = [
	TimedDelivery(0x97, EventFlag.unknown0B4, 0x0006, 0x000F, 0x00B4, textDelivery1, textDelivery1Fail, 0x0200, 0x0200),
	TimedDelivery(0x87, EventFlag.unknown0B5, 0x0006, 0x000F, 0x000A, textDelivery2, textDelivery2Fail, 0x0180, 0x0180),
	TimedDelivery(0x87, EventFlag.unknown285, 0x0006, 0x000F, 0x000A, textDelivery3, textDelivery3Fail, 0x0180, 0x0180),
	TimedDelivery(0x37, EventFlag.forSaleSignNPC1Coming, 0x0006, 0x000F, 0x0001, textDelivery4, textDelivery4Fail, 0x0280, 0x0280),
	TimedDelivery(0x6C, EventFlag.forSaleSignNPC2Coming, 0x0006, 0x000F, 0x0002, textDelivery5, textDelivery4Fail, 0x0280, 0x0280),
	TimedDelivery(0x70, EventFlag.forSaleSignNPC3Coming, 0x0006, 0x000F, 0x0003, textDelivery6, textDelivery4Fail, 0x0280, 0x0280),
	TimedDelivery(0x55, EventFlag.forSaleSignNPC4Coming, 0x0006, 0x000F, 0x0004, textDelivery7, textDelivery4Fail, 0x0280, 0x0280),
	TimedDelivery(0x97, EventFlag.deliveringZombiePaper, 0x00FF, 0x00FF, 0x0005, textDelivery8, textDelivery8Fail, 0x0180, 0x0180),
	TimedDelivery(0x87, EventFlag.unknown2B6, 0x0006, 0x000F, 0x000A, textDelivery9, textDelivery9Fail, 0x0180, 0x0180),
	TimedDelivery(0x87, EventFlag.unknown2B7, 0x0006, 0x000F, 0x000A, textDelivery10, textDelivery10Fail, 0x0180, 0x0180),
];
