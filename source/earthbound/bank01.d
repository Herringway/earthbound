...
unittest {
	if (romDataLoaded) {
		...
		createWindow(Window.textStandard);
		static immutable testStr = ebStringz("@I was too busy to investigate, but I heard a child's voice on the hilltop.\x02");
		displayText(&testStr[0]);
		const window = windowStats[windowTable[Window.textStandard]];
		static immutable ushort[][] expected = [
			[ 0x3C10, 0x3C11, 0x3C11, 0x3C11, 0x3C11, 0x3C11, 0x3C11, 0x3C11, 0x3C11, 0x3C11, 0x3C11, 0x3C11, 0x3C11, 0x3C11, 0x3C11, 0x3C11, 0x3C11, 0x3C11, 0x7C10 ],
			[ 0x3C12, 0x204E, 0x204C, 0x205D, 0x205B, 0x2059, 0x2057, 0x2055, 0x206E, 0x206C, 0x206A, 0x207E, 0x207C, 0x207A, 0x208E, 0x208C, 0x208A, 0x2088, 0x7C12 ],
			[ 0x3C12, 0x204D, 0x205E, 0x205C, 0x205A, 0x2058, 0x2056, 0x206F, 0x206D, 0x206B, 0x207F, 0x207D, 0x207B, 0x208F, 0x208D, 0x208B, 0x2089, 0x2087, 0x7C12 ],
			[ 0x3C12, 0x2084, 0x2086, 0x2082, 0x209F, 0x209D, 0x209B, 0x2099, 0x2097, 0x2095, 0x2093, 0x2091, 0x20AE, 0x20AC, 0x20AA, 0x20A8, 0x20A6, 0x20A4, 0x7C12 ],
			[ 0x3C12, 0x2083, 0x2085, 0x2081, 0x209E, 0x209C, 0x209A, 0x2098, 0x2096, 0x2094, 0x2092, 0x20AF, 0x20AD, 0x20AB, 0x20A9, 0x20A7, 0x20A5, 0x20A3, 0x7C12 ],
			[ 0x3C12, 0x20A2, 0x20A0, 0x20BE, 0x20BC, 0x20BA, 0x20B8, 0x20B6, 0x2040, 0x2040, 0x2040, 0x2040, 0x2040, 0x2040, 0x2040, 0x2040, 0x2040, 0x2040, 0x7C12 ],
			[ 0x3C12, 0x20A1, 0x20BF, 0x20BD, 0x20BB, 0x20B9, 0x20B7, 0x20B5, 0x2040, 0x2040, 0x2040, 0x2040, 0x2040, 0x2040, 0x2040, 0x2040, 0x2040, 0x2040, 0x7C12 ],
			[ 0xBC10, 0xBC11, 0xBC11, 0xBC11, 0xBC11, 0xBC11, 0xBC11, 0xBC11, 0xBC11, 0xBC11, 0xBC11, 0xBC11, 0xBC11, 0xBC11, 0xBC11, 0xBC11, 0xBC11, 0xBC11, 0xFC10 ]
		];
		// tile map
		assert(bg2Buffer[window.y * 32 + window.x .. $].chunks(32).map!(x => x.take(window.width + 2)).take(window.height + 2).equal(expected));
		// tiles
		assert(vwfBuffer[0 .. 35] == cast(immutable typeof(vwfBuffer[0])[])import("textsampletiles.bin"));
	}
}
