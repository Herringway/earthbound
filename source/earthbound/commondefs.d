...
enum EventFlag {
	...
	hideOnettDrugstore = 0x22E,
	hideOnettBurgerShop = 0x22F,
	hideOnettHotel = 0x230,
	hideOnettHospital = 0x231,
	hideOnettBakery = 0x232,
	hideOnettToTwoson = 0x233,
	hideTwosonHotel = 0x234,
	hideTwosonDeptStore = 0x235,
	hideTwosonToOnett = 0x236,
	hideTwosonBusStop = 0x237,
	hideTwosonHospital = 0x238,
	hideTwosonToThreed = 0x239,
	hideThreedShop = 0x23A,
	hideThreedHotel = 0x23B,
	unknown0572 = 0x23C,
	hideThreedBakery = 0x23D,
	hideThreedHospital = 0x23E,
	hideFoursideHospital = 0x23F,
	hideFoursideDeptStore = 0x240,
	hideFoursideBakery = 0x241,
	hideFoursideHotel = 0x242,
	hideScarabaHotel = 0x243,
	hideScarabaHospital = 0x244,
	hideScarabaShop = 0x245,
	hideSummersHotel = 0x246,
	hideSummersRestaurant = 0x247,
	hideSummersShop1 = 0x248,
	hideSummersHospital = 0x249,
	hideSummersShop2 = 0x24A,
	bgmFlyingMan = 0x24B,
	...
	hideFoursideToDesert = 0x280,
	hideThreedToDesert = 0x281,
	hideThreedToTwoson = 0x282,
	...
	hideTwosonBakery = 0x2A1,
	hideScarabaBakery = 0x2A2,
	deliveryHoihoi = 0x2A3,
	hideThreedBusStop1 = 0x2A4,
	hideThreedBusStop2 = 0x2A5,
	hideFoursideBusStop = 0x2A6,
	unknown0679 = 0x2A7,
...
struct TownMapIconPlacement {
	...
	ubyte y; ///
	ubyte sprite; ///
	ushort eventFlag; /// Event flag to disable icon appearance
}
///
struct SpriteMap {
	ubyte yOffset; ///
...
private auto printableScriptName(const(void)* addr) {
	static struct Result {
		...
		void toString(W)(ref W writer) const {
			...
			writer.formattedWrite!"0x%X"(cast(size_t)addr);
		}
	}
	return Result(addr);
}
void printActionscriptCommand(size_t entityID, size_t scriptSlot, const(ubyte)* stream) {
	printActionscriptCommand(entityID, scriptSlot, stream[0 .. size_t.max]);
}
void printActionscriptCommand(size_t entityID, size_t scriptSlot, const(ubyte)[] stream) {
	...
	tracef("Entity %s/%s: (%s) %s", entityID, scriptSlot, printableScriptName(&stream[0]), actionScriptCommandPrinter(stream));
}
