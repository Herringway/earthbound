...
ubyte[] EVENT_LONG_RETURN(const void* ptr) {
...
ubyte[] EVENT_SHORTCALL_CONDITIONAL(void function() ptr) {
	return actionCommand(0x0A, ptr);
}

ubyte[] EVENT_SHORTCALL_CONDITIONAL_NOT(void function() ptr) {
...
ubyte[] EVENT_SET_VAR(ubyte var, short val) {
...
ubyte[] EVENT_BINOP(ubyte var, ubyte op, short value) {
...
ubyte[] EVENT_BREAK_IF_FALSE(void* ptr) {
	return actionCommand(0x16, ptr);
}

ubyte[] EVENT_BREAK_IF_TRUE(void* ptr) {
...
ubyte[] EVENT_EX_CALLROUTINE(T...)(ubyte ex, short function(short, ref const(ubyte)*) ptr, T args) {
	return actionCommand(0xF0 + ex, ptr, args);
}
