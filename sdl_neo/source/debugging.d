				...
				if (ImGui.TreeNode("Scripts")) {
					...
					do {
						if (ImGui.TreeNode(format!"Script %s"(scriptIndex))) {
							...
							InputEditable("Temp var", entityTempvars[scriptIndex]);
							ImGui.TreePop();
						}
