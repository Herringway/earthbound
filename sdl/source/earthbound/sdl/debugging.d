...
void renderDebugWindow(float x, float y, float width, float height) {
	...
	if (ImGui.TreeNode("Overworld State")) {
		...
		InputEditable("Door found type", doorFoundType);
